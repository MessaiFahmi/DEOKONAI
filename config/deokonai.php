...
return [
    ...
    'update' => [
        ...
        */
        ...
        'default_repository_type' => env('DEOKONAI_UPDATE_REPOSITORY_TYPE', 'github'),
        ...
        */
        ...
        'repository_types' => [
            'github' => [
                'owner' => env('DEOKONAI_UPDATE_REPOSITORY_OWNER', 'Mathsyo'),
                'repository' => env('DEOKONAI_UPDATE_REPOSITORY_NAME', 'MyPHPFramework'),
                // 'repository_url' => '',
                // 'download_path' => env('SELF_UPDATER_DOWNLOAD_PATH', '/tmp'),
                'private_access_token' => env('DEOKONAI_UPDATE_REPOSITORY_PRIVATE_ACCESS_TOKEN', ''),
                'use_branch' => env('none', ''),
            ],
            // 'http' => [
            //     'type' => 'http',
