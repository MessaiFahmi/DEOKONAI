...
return [
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type' => 'github',
            'repository_vendor' => env('SELF_UPDATER_REPO_VENDOR', 'Mathsyo'),
            'repository_name' => env('SELF_UPDATER_REPO_NAME', 'MyPHPFramework'),
            'repository_url' => '',
            'download_path' => env('SELF_UPDATER_DOWNLOAD_PATH', '/tmp'),
            'private_access_token' => env('SELF_UPDATER_GITHUB_PRIVATE_ACCESS_TOKEN', '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'),
